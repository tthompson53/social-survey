...
We start with GSS data from the three years and then use the select function from the dplyr package to extract 12 variables that we think are important, but for this research paper, we will only be using the following variables; belief in the gun ownership, race, sex, political beliefs,opinions on capitol punishment and belief in God. But, we still need to clean the data up a bit more. This was done in the following ways:
  ...
  * For political beliefs, it was orginally recorded as having 6 different levels. Using the revalue function, we condensed the number of levels down to three. For the responses of **IAP** and **DK** we changed the value to **NA**. For the responses of **EXTREMELY LIBERAL** and **SLIGHTLY LIBERAL** we changed the value to **LIBERA**L. For the responses of SLIGHTLY CONSERVATIVE and EXTREMELY CONSERVATIVE we changed the value to **CONSERVATIVE**.
...
After viewing the data numerically, both **BLAC**K and **OTHER** strongly voted **NO** on gun ownership, whereas the group **WHITE** had more **YES** on gun ownership compared to the two other groups. 
...
$H_0$ Belief in gun ownership is independent of Sex.    
 
$H_a$ Belief in gun ownership and sex are related. (not independent)
...
$H_0$ Belief in gun ownership is independent of Race.    

$H_a$ Belief in gun ownership and Race are related. (not independent)  
...
$H_0$ Belief in gun ownership is independent of political view.    

$H_a$ Belief in gun ownership and political views are related. (not independent)  
...
$H_0$ Belief in gun ownership is independent of belief in capital punishment.    

$H_a$Belief in gun ownership and belief in capital punishment are related. (not independent)  
...
$H_0$ Belief in gun ownership is independent of belief in God.    

$H_a$Belief in gun ownership and belief in God are related. (not independent)  
